        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <a href="{{ route('admin.technologies.create') }}" class="btn btn-info w-100">
                            + Aggiungi
                        </a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($technologies as $technology)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.technologies.show', ['technology' => $technology->id]) }}" class="btn btn-xs btn-info">
                                            Vedi
                                        </a>
                                        <a href="{{ route('admin.technologies.edit', ['technology' => $technology->id]) }}" class="btn btn-xs btn-secondary">
                                            Modifica
                                        </a>
                                        <form class="d-inline-block" action="{{ route('admin.technologies.destroy', ['technology' => $technology->id]) }}" method="post" onsubmit="return confirm('Sei sicuro di voler eliminare questa categoria?');">
                                            @csrf
                                            @method('DELETE')
                                            <button technology="submit" class="btn btn-dark">
                                                Elimina
                                            </button>
                                        </form>
                                    </td>
